...
public:
	...
	*/
        ...
        /// Actions
                ...
                void RunLuaScript(const TCHAR* ScriptText);
                // Execute a Lua script from a file
                void RunLuaScriptFile(const TCHAR* FilePath);
                // Create a new Lua context and switch to it
                void CreateContext();
                // Switch current context by index
        ...
        /// Expressions
                ...
                // Returns the active Lua context index
        ...
        void RegisterFusionFunctions(lua_State* state);
