/*
	This GravitySim Fusion extension HTML5 port is under MIT license.
...
CRunDarkEdif_Template.prototype = CServices.extend(new CRunExtension(), {
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to GravitySim.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to GravitySim.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to GravitySim.";
		}
