...
public:
	...
	*/
        ...
        /// Actions
                // Execute a block of JS code in current context
        ...
        static duk_ret_t JS_ListObjects(duk_context* ctx);
        static duk_ret_t JS_GetPosition(duk_context* ctx);
        static duk_ret_t JS_SetPosition(duk_context* ctx);
        static duk_ret_t JS_GetAltValue(duk_context* ctx);
        static duk_ret_t JS_SetAltValue(duk_context* ctx);
