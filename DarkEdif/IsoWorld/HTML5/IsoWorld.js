/*
	This IsoWorld Fusion extension HTML5 port is under MIT license.
...
function CRunIsoWorld() {
	...
	// Actions
	// ======================================================================================================
	this.Action_LoadTMX = function (path) {};
	this.Action_LoadJSON = function (path) {};
	this.Action_SaveJSON = function (path) {};
	this.Action_ExportLayer = function (path, layer) {};
	this.Action_SetTileHeights = function (layer, x, y, tl, tr, bl, br) {};
	this.Action_SetTileMask = function (layer, x, y, mask) {};
	this.Action_MoveBody = function (name, dx, dy, dz) {};
	this.Action_TeleportIfClear = function (name, x, y, z) {};
	this.Action_ClearChunkCache = function () {};
	this.Action_SpawnBodies = function (layer) {};
	this.Action_EnableCCD = function (name, enabled) {};
	this.Action_SetBodyPhysics = function (name, gravity, friction, bounce) {};
	this.Action_SetDebugOverlay = function (enabled) {};

	// ======================================================================================================
	// Conditions
	// ======================================================================================================
	this.Condition_OnTMXLoadSuccess = function () { return false; };
	this.Condition_OnTMXLoadFailure = function () { return false; };
	this.Condition_OnCollisionStart = function (name) { return false; };
	this.Condition_OnCollisionEnd = function (name) { return false; };
	this.Condition_OnClearPath = function (name) { return false; };
	this.Condition_OnLanding = function (name) { return false; };
	this.Condition_OnLeavingGround = function (name) { return false; };
	this.Condition_OnTileTypeInRegion = function (layer, terrain, x1, y1, x2, y2) { return false; };

	// =============================
	// Expressions
	// =============================

	this.Expression_WorldToScreenX = function (x, y, z) { return 0; };
	this.Expression_WorldToScreenY = function (x, y, z) { return 0; };
	this.Expression_ScreenToTileQ = function (x, y) { return 0; };
	this.Expression_ScreenToTileR = function (x, y) { return 0; };
	this.Expression_TileHeightAt = function (layer, x, y) { return 0; };
	this.Expression_SurfaceNormalX = function (layer, x, y) { return 0; };
	this.Expression_SurfaceNormalY = function (layer, x, y) { return 0; };
	this.Expression_SurfaceNormalZ = function (layer, x, y) { return 1; };
	this.Expression_RaycastDistance = function (x1, y1, z1, x2, y2, z2) { return -1; };
	this.Expression_DepthSortKey = function (x, y, z) { return 0; };
	this.Expression_BodyContactFlags = function (name) { return 0; };
	this.Expression_TileProperty = function (layer, x, y, key) { return ""; };
	this.Expression_TilesetProperty = function (gid, key) { return ""; };
	this.Expression_LayerParallaxX = function (layer) { return 1; };
	this.Expression_LayerParallaxY = function (layer) { return 1; };
	this.Expression_BodyX = function (name) { return 0; };
	this.Expression_BodyY = function (name) { return 0; };
	this.Expression_BodyZ = function (name) { return 0; };
	...
	this.$actionFuncs = [
	/* 0 */ this.Action_LoadTMX,
	/* 1 */ this.Action_LoadJSON,
	/* 2 */ this.Action_SaveJSON,
	/* 3 */ this.Action_ExportLayer,
	/* 4 */ this.Action_SetTileHeights,
	/* 5 */ this.Action_SetTileMask,
	/* 6 */ this.Action_MoveBody,
	/* 7 */ this.Action_TeleportIfClear,
	/* 8 */ this.Action_ClearChunkCache,
	/* 9 */ this.Action_SpawnBodies,
	/* 10 */ this.Action_EnableCCD,
	/* 11 */ this.Action_SetBodyPhysics,
	/* 12 */ this.Action_SetDebugOverlay
	];
	this.$conditionFuncs = [
	/* 0 */ this.Condition_OnTMXLoadSuccess,
	/* 1 */ this.Condition_OnTMXLoadFailure,
	/* 2 */ this.Condition_OnCollisionStart,
	/* 3 */ this.Condition_OnCollisionEnd,
	/* 4 */ this.Condition_OnClearPath,
	/* 5 */ this.Condition_OnLanding,
	/* 6 */ this.Condition_OnLeavingGround,
	/* 7 */ this.Condition_OnTileTypeInRegion
	];
	this.$expressionFuncs = [
	/* 0 */ this.Expression_WorldToScreenX,
	/* 1 */ this.Expression_WorldToScreenY,
	/* 2 */ this.Expression_ScreenToTileQ,
	/* 3 */ this.Expression_ScreenToTileR,
	/* 4 */ this.Expression_TileHeightAt,
	/* 5 */ this.Expression_SurfaceNormalX,
	/* 6 */ this.Expression_SurfaceNormalY,
	/* 7 */ this.Expression_SurfaceNormalZ,
	/* 8 */ this.Expression_RaycastDistance,
	/* 9 */ this.Expression_DepthSortKey,
	/* 10 */ this.Expression_BodyContactFlags,
	/* 11 */ this.Expression_TileProperty,
	/* 12 */ this.Expression_TilesetProperty,
	/* 13 */ this.Expression_LayerParallaxX,
	/* 14 */ this.Expression_LayerParallaxY,
	/* 15 */ this.Expression_BodyX,
	/* 16 */ this.Expression_BodyY,
	/* 17 */ this.Expression_BodyZ
	];
}
//
CRunIsoWorld.prototype = CServices.extend(new CRunExtension(), {
	...
	getNumberOfConditions: function() {
		...
		return 8; // $conditionFuncs not available yet
	},
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to IsoWorld.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to IsoWorld.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to IsoWorld.";
		}
