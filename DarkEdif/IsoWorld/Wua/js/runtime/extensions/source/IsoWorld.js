/*
	This IsoWorld Fusion extension UWP port is under MIT license.
*/
...
function CRunIsoWorld() {
	...
	// Conditions
	// ======================================================================================================
	this.Condition_OnTMXLoadSuccess = function (name) { return false; };
	this.Condition_OnTMXLoadFailure = function (name) { return false; };
...
CServices.extend(CRunExtension, CRunIsoWorld);
